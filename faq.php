...
<div class="misc-container">
    ...
    print_qa("Where is it hosted?", "Gufo has no set location for more than a few days.
...
<br>It works like this:<br>Search -> Gufo fetches several engines using CURL with its own IP -> Parse -> Format -> Done, you may now see the results");
    ...
    <br>You may manage/inspect all cookies by opening the Developer Tools -> Storage -> Cookies -> Gufo
    ...
    <hr>
    <?php
    print_qa("Does Gufo support bangs?", "Yes because Gufo implemented this feature. It's the same syntax as on DuckDuckGo.");
    ...
    print_qa("How can I set Gufo as my search engine?", "
